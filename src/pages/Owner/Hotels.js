...
const Hotels = () => {
  ...
  const getHotels = async () => {
    const response = await getmyHotelsOwnerApi()

   

    setMyHotels(response)
                        ...
                        <tr key={hotel._id} className="bg-white border-b  text-black hover:bg-gray-300 ">
                          ...
                          <td className="px-6 py-4 ">
                            ...
                            <div className=' w-1/2 flex flex-col'>
                              ...
                              <button className=' border px-3 py-0.5 rounded-md bg-red-500' onClick={() => deleteHotel(hotel._id)}>Delete</button>
                            </div>
                          </td>
