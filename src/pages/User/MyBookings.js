...
import { myBookingDataOwnerApi } from '../../helpers/apis/userApis'
...
const MyBookings = () => {
    ...
    const getMyBookings = async ()=>{
        const response = await myBookingDataOwnerApi()
  ...
  return (
      <div className='h-screen '>
          ...
          <div className='container mx-auto'>
            <h1 className='my-10'>Bookings </h1>
                              ...
                              <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                                  ...
                                  {/* <div className="absolute flex justify-center bottom-0 mb-3">
                                      <div className="flex bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow">
                                          ...
                                          {
                                            data.status?
                                            <span className="absolute top-0 left-0 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 bg-green-400 text-sm font-medium text-white select-none">
                                                Approved
                                            </span>:
